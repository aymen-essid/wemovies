 ...
 */
final class Version20240419101439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE film (id INT AUTO_INCREMENT NOT NULL, gender_id INT NOT NULL, name VARCHAR(255) NOT NULL, year DATE NOT NULL, description LONGTEXT NOT NULL, producer VARCHAR(255) NOT NULL, source LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_8244BE22708A0E0 (gender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
